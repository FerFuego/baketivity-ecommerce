...
//var_dump($subscription->has_payment_gateway());
//var_dump(wc_get_payment_gateway_by_order($subscription));
//var_dump(wc_get_payment_gateway_by_order( $subscription )->supports( 'subscriptions' ));
//$order = wc_get_order(74287 ); 
//var_dump(wc_get_payment_gateway_by_order($subscription));
?>
