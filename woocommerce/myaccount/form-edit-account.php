...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action('woocommerce_edit_account_form_tag'); ?> id="resetPasswordFormAccount">
...
<script>
    ...
    var resetPasswordForm = document.getElementById("resetPasswordFormAccount");
