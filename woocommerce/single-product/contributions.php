...
<div id="reviews">
	...
	<div class="product-rating">
			<div class="product-rating-summary">
				...
				$reviews_label  = sprintf( __( 'Rate %s', 'woocommerce-product-reviews-pro' ), $average_rating, 5 );
				...
				<div class="review-rate-container">
					...
					<a href="#review_form_wrapper" class="write-review">Write a review</a>
				</div>
			</div> <!-- product-rating-summary -->
		</div> <!-- product-rating -->
	...
	<div id="comments">
		...
		<form method="get" action="#comments" class="contributions-filter">
			...
			// Filter options
			$options = array(
				'' => __( 'TOP REVIEWS', 'woocommerce-product-reviews-pro' ),
			);
			...
			$options[ 'comment_type=review&classification=negative&rating=5'] = __( 'rating ', 'woocommerce-product-reviews-pro' );
...
<?php if ($product->get_review_count() > 3) { ?>
<div id="loadMore">Load more reviews</div>
<?php } ?>

<h3 class="contributions-form-title"><?php esc_html_e( 'Add Your Review', 'woocommerce-product-reviews-pro' ); ?></h3>
	...
	<?php foreach ( $contribution_types as $type ) : ?>
		...
		<?php if ( 'contribution_comment' !== $type ) : $key++; ?>
			...
			<div id="<?php echo esc_attr( $type ); ?>_form_wrapper" class="contribution-form-wrapper active <?php if ( $key === 1 ) : ?>active<?php endif; ?>">
...
<div class="review-transition"></div>