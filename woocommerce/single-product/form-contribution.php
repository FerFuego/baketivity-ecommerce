		...
		<?php if ( wc_product_reviews_pro_is_contribution_form_enabled( $type, $product ) ) : ?>
			...
			<?php if ( ! is_user_logged_in() && get_option( 'require_name_email' ) && ! get_option( 'comment_registration' ) ) : ?>
				...
				<?php if ( ! isset( $fields['author'] ) ) : ?>
					<?php $fields['author'] = array( 'label' => '<i class="fas fa-user"></i>','placeholder'=>'Name', 'required' => true ); ?>
				<?php endif; ?>

				<?php if ( ! isset( $fields['email'] ) ) : ?>
					<?php $fields['email'] = array( 'label' => '<i class="fa fa-envelope" aria-hidden="true"></i>','placeholder'=>'Email', 'required' => true ); ?>
				<?php endif; ?>

			<?php endif; 
				$fields['review_title'] = array( 'label' => '','placeholder'=>'Review Title');
				$fields['review_comment'] = array( 'label' => '','placeholder'=>'Your Review','type' =>'textarea');
			?>
