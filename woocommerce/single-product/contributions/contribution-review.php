...
<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
	...
	<div id="comment-<?php comment_ID(); ?>" class="comment_container 123123">
		...
		<div class="comment-text">
			...
			<div class="description"><?php comment_text(); wc_product_reviews_pro_contribution_attachments( $contribution );?></div>
