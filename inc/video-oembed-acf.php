...
function videoSupport($args = ['field' => 'video', 'post_id' => null, 'placeholder_url' => null, 'button_content' => 'Play >', 'video_url' => null])
{
    if (isset($args['video_url'])) {
        $videoUrl = $args['video_url'];
    } else if (isset($args['post_id']) && get_field($args['field'], $args['post_id'])) {
        $videoUrl = get_field($args['field'], $args['post_id'], false);
    } else {
        $videoUrl = get_sub_field($args['field'], false);
    }
